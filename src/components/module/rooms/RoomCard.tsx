...
export function RoomCard({ room }: RoomCardProps) {
  ...
  return (
    <Card
      className="overflow-hidden rounded-2xl border border-stone-200 p-0 shadow-sm hover:shadow-md transition-all duration-300 hover:-translate-y-1 cursor-pointer group bg-white"
